...
var (
	GameNames                 = []string{"2kki", "amillusion", "braingirl", "deepdreams", "flow", "genie", "mikan", "muma", "nostalgic", "oversomnia", "prayers", "sheawaits", "someday", "tsushin", "ultraviolet", "unevendream", "yume"}
